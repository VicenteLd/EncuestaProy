...
public class listado1 extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener{
    //TextView txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listado1);
    ...
    private void cargarWebService(String carrera) {
        ...
        String url = "https://chronox.me/trayectoria/web_service/php_c1/listadocarr.php?carrera=" + carrera;
