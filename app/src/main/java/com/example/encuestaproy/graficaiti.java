...
public class graficaiti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graficaiti);

        imprimirgrafica("https://chronox.me/trayectoria/web_service/php_c1/itiencuestaFN.php");
