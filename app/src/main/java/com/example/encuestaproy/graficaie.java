...
public class graficaie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graficaie);

        imprimirgrafica("https://chronox.me/trayectoria/web_service/php_c1/ieencuestaFN.php");
    }
